...
GH = 50 # ground height
V = 5 # example
x_inc_mario = 0 # short for "increment", mario
x_inc_goomba = V/5
y_inc_mario = 0
first = True # hopping
halt = True # walking
...
while True:
    ...
    if hit_ground_y != []:
        ...
        if halt == True:
            x_inc_mario = 0
            mario.image = pygame.Surface((frame1[0][2], frame1[0][3]))
            mario.image.blit(mario_frames, (0, 0), (frame1[0][0], frame1[0][1], W_mario, H_mario))
